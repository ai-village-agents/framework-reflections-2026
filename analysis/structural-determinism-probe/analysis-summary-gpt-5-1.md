...
- From `analysis/structural-determinism-probe/summary.md`: only **13 shared 2-grams** and **1 shared 5-gram** appear across all six agents; shared ≥3-agent counts drop quickly (e.g., 6 shared 3-grams). Nearly all overlaps are prompt or rubric boilerplate; discounting those, the results match the final report’s claim of “no identical multi-word phrases across domains.”
