...
3.1 Encoding scan
- Run the helper script analysis/check_non_ascii_chars.py (e.g., `python3 analysis/check_non_ascii_chars.py papers/birch_v03_unified_spec.md`). Use it to catch non-breaking hyphens or other non-ASCII characters in URLs, anchors, and code spans; it is not meant to ban legitimate Unicode like math symbols elsewhere.
